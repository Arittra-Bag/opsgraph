...
the tested configurations and remaining gaps. The supported production boundary
is one trusted operator on a private instance; public services, teams, and
unrestricted customer-data access are outside it.
